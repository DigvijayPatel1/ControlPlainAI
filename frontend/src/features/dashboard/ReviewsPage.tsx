            ...
            <Panel title="Human review queue">
                {isLoading ? (
                    ...
                    <div className="flex flex-col gap-4">
                        {reviews.map((review) => (
                            <article key={review.review_id} className="rounded-xl border border-line p-4">
                                ...
                                <button
                                    ...
                                    onClick={() => approve(review.review_id)}
                                    className="rounded-lg border border-brand-green px-3 py-1.5 text-sm font-medium text-brand-green transition-colors hover:bg-mint disabled:opacity-50"
                                >
